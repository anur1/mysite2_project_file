...
STATIC_ROOT = BASE_DIR / "staticfiles" #bütüm static dosyaları tarayıp staticfiles içine kopyalar bunun için (myenv) > python manage.py collectstatic çalıştırılır. site yayınlanlandığında sadece staticfiles nazara alınır. static'e kleme yapıldığında collectstatic yeniden çalıştırılır. static files'a dışarıdan müdahale edilmez. 
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
